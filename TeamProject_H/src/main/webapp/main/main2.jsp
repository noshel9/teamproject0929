    ...
    <div id="fullpage">
        ...
        <div class="section" id="section2">
            <div class="mem">
               ...
               <div class="member_int">
               	<ul class="intro">
               		<li><img alt="" src="../img/cat_hand_gray.png"><h6 id="mem_name">구다은</h6><h6 id="mem_email">daeunk96@gmail.com</h6></li>
               		<li><img alt="" src="../img/cat_hand_gray.png"><h6 id="mem_name">손성훈</h6><h6 id="mem_email">ssh910525@gmail.com</h6></li>
               		<li><img alt="" src="../img/cat_hand_brown.png"><h6 id="mem_name">안현주</h6><h6 id="mem_email1">guswn8438@gmail.com</h6></li>
               		<li><img alt="" src="../img/cat_hand_gray.png"><h6 id="mem_name">최태훈</h6><h6 id="mem_email">t174@naver.com</h6></li>
               	</ul>
               </div>
        </div>
